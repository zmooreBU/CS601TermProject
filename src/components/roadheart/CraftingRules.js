...
function CraftingRules() {
    return(
        <main className="roadheart-no-sidebar">
            ...
            <Link to="/CS601TermProject/projects/roadheart-repository/store" className="roadheart-link"><img src="/CS601TermProject/assets/potion.svg" /><h2>View Craftable Items</h2></Link>
        </main>
    );
}
